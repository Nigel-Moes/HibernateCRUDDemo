...
public class HibernateCrudDemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		// create more courses
		Course tempCourse1 = new Course("Dutch");
		Course tempCourse2 = new Course("Computer Science");
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		// create a course
		Course tempCourse = new Course("Spanish");

		// create the students
		Student tempStudent1 = new Student("John", "Test", "john@test.com");
